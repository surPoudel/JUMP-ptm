    ...
    with open(tag_file,"r") as f:
        ...
        for line in f:
            ...
            if '.tag' in line:
                ...
                # jump_key = temp_line[0]+"."+scan5digit+"."+str(temp_line[2])+"."+str(temp_line[3])
                ...
                link_key = comet_key+"__"+neutral_mass #we are adding w010.00500.00500.3 with neutral mass (MH)
                tag = tag_info[1]
                rtFlank = tag_info[2]
