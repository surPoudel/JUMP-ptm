...
There are two sets of sample data in the sample data folder https://github.com/surPoudel/JUMP-ptm/tree/main/sample_data. 
 - fraction w001 (has a demo spectra of total 792)
 - fraction w010 (has a demo spectra of total 654)
